package com.hclsample.rajesh.xplore
...
import com.hclsample.rajesh.xplore.model.GeoCodeResponse
import com.hclsample.rajesh.xplore.network.NetworkHandler
import com.hclsample.rajesh.xplore.network.RetrofitApiClient
import com.hclsample.rajesh.xplore.ui.fragment.ResultFragment
import com.hclsample.rajesh.xplore.ui.fragment.SearchFragment
...
class MainActivity : AppCompatActivity(), SearchFragment.onXploreClickListener,
    ...
    override fun onResultClicked(place: PlacesPOJO.CustomA) {
        ...
        val navOptions = NavOptions.Builder()
            ...
            .build()
        this.findNavController(R.id.fragmentNavHost)
            .navigate(R.id.action_resultFragment_to_mapFragment, args, navOptions);
    }
